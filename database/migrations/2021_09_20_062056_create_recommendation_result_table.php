...
class CreateRecommendationResultTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('deploy_payment_pgsql')->create('recommendation_result', function (Blueprint $table) {
    ...
    {
        Schema::connection('deploy_payment_pgsql')->dropIfExists('recommendation_result');
    }
}

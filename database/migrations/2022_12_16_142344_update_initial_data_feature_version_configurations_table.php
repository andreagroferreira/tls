...
class UpdateInitialDataFeatureVersionConfigurationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        try {
            DB::connection('deploy_payment_pgsql')->statement('TRUNCATE TABLE feature_version_configurations RESTART IDENTITY CASCADE');
            DB::connection('deploy_payment_pgsql')->beginTransaction();
            $client = $this->getProjectId();
            $types = [1 => 'invoice', 2 => 'transaction_sync'];

...
$router->group(['prefix' => 'api/v1', 'namespace' => 'V1'], function () use ($router) {
    ...
    $router->put('payment-configurations/{pa_id}', 'PaymentAccountsController@update');
    $router->get('payment-accounts', 'PaymentConfigurationsController@getPaymentAccounts');

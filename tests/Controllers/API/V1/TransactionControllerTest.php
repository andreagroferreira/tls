...
class TransactionControllerTest extends TestCase
{
    ...
    public function testListTransactionsWithStartDateAndEndDateValidation(): void
    {
        ...
        $this->response->assertStatus(400)
            ->assertJson([
                'error' => 'params error',
                'message' => 'The start date must be a date before or equal to end date.',
            ]);
    }
    ...
    public function testTransactionWithFreeBasketItems(array $defaultPayload): void
    {
        ...
        $this->setFeatureVersions(2, 'free_transaction');
        $this->setFeatureVersions(2, 'receipt');
        ...
        $this->seeInDatabase('jobs', ['queue' => 'tlspay_receipt_queue'], $this->dbConnection);
